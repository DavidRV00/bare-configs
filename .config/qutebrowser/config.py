...
with open('/home/david/.config/qutebrowser/searchengines') as csvfile:
    ...
    for row in reader:
        c.url.searchengines[row[0]] = row[1]
...
# c.fonts.tabs.selected = "11pt Ubuntu Mono"
# c.fonts.tabs.unselected = "11pt Ubuntu Mono"
# c.fonts.statusbar = "11pt Ubuntu Mono"
...
config.bind(';q', 'hint links spawn umpv-ctrl loadfile {hint-url} append')
config.bind(',q', 'spawn umpv-ctrl loadfile {url} append')
config.bind(';M', 'hint links spawn mpv {hint-url}')
config.bind(',M', 'spawn mpv {url}')
# config.bind(';M', 'hint --rapid links spawn umpv {hint-url}')

config.bind(';R', 'hint links spawn getrss-youtube {hint-url}')
...
# config.bind('/', 'set statusbar.show always;; set-cmd-text /')
# config.bind('?', 'set statusbar.show always;; set-cmd-text ?')
# config.bind('<Escape>', 'enter-mode normal;; set statusbar.show never', mode='command')
# config.bind('<Return>', 'command-accept;; set statusbar.show never', mode='command')
#
# config.bind('kj', 'enter-mode normal;; set statusbar.show never', mode='command')
...
# base00 = "#161616" # Unselected background - even
# base01 = "#161616" # Unselected background - odd
base00 = "#162023" # Unselected background - even
base01 = "#162023" # Unselected background - odd
# base02 = "#3a3a3a" # Selected background
base02 = "#5f87d7" # Selected background
# base03 = "#"
# base04 = "#"
# base05 = "#5f87d7" # Selected foreground
base05 = "#161616" # Selected foreground
# base06 = "#"
# base07 = "#555555" # Unselected foreground
base07 = "#dfdfdf" # Unselected foreground
# base08 = "#"
# base09 = "#"
# base0A = "#"
base0B = "#ffffff" # Normal statusbar fg
base0C = "#080808" # Indicator end
base0D = "#ffffff" # Indicator start
base0E = "#162023"
base0F = "#ee1033"
...
c.colors.statusbar.normal.bg = base0E
#
# # Foreground color of the statusbar in insert mode.
c.colors.statusbar.insert.fg = base0F
#
